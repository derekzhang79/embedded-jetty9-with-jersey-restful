...
public class CompositeKey {
	...
	public static class Two<T1, T2> implements Comparable<Two<T1, T2>> {
		...
		public static final ZSimpleObjectPool<CompositeKey.Two> ObjectPool = new ZSimpleObjectPool<CompositeKey.Two>(
				ZUtil.getClassSimpleName(CompositeKey.class) + "." + ZUtil.getClassSimpleName(CompositeKey.Two.class), 0, new IZStructor<CompositeKey.Two>() {
					@Override
					public CompositeKey.Two ctor() {
						return new CompositeKey.Two();
					}
				}, null, new IZDestructor<CompositeKey.Two>() {
					@Override
					public CompositeKey.Two dtor(CompositeKey.Two o) {
						o.value1 = null;
						o.value2 = null;
						return o;
					}
	...
	public static class Three<T1, T2, T3> implements Comparable<Three<T1, T2, T3>> {
		...
		public static final ZSimpleObjectPool<CompositeKey.Three> ObjectPool = new ZSimpleObjectPool<CompositeKey.Three>(
				ZUtil.getClassSimpleName(CompositeKey.class) + "." + ZUtil.getClassSimpleName(CompositeKey.Three.class), 0, new IZStructor<CompositeKey.Three>() {
					@Override
					public CompositeKey.Three ctor() {
						return new CompositeKey.Three();
					}
				}, null, new IZDestructor<CompositeKey.Three>() {
					@Override
					public CompositeKey.Three dtor(CompositeKey.Three o) {
						o.value1 = null;
						o.value2 = null;
						o.value3 = null;
						return o;
